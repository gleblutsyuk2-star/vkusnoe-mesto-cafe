const dishes=[
  {category:'pizza',name:'Мясная пицца',description:'Румяный бортик, мясная начинка и сыр',price:590,image:'food-2.jpg',alt:'Пицца с мясной начинкой — фото из карточки кафе'},
